...
namespace sprawko.Pages
{
    public class IndexModel : PageModel
    {
        ...
        private readonly IHistoryRepository<LeapYearCheck> _leapYearCheckRepository;

        public IndexModel(UserManager<User> userManager, IHistoryRepository<LeapYearCheck> leapYearCheckRepository)
        {
